...
opts.gradientClipping = false; %%% set 'true' to prevent exploding gradients in the beginning.设置“true”以防止开始时的渐变爆炸。
opts.backPropDepth    = Inf;
%%%-------------------------------------------------------------------------
%%%   Initialize model and load data初始化模型并加载数据
%%%---------------------------------------------------- 
...
%opts.imdbDir          = 'E:/MWCNN-1/MWCNN-2/DN_PATCH192';
opts.imdbDir          = 'C:\Users\个人电脑\Desktop\ZJJhzn\MWCNN_2_copy\DN_PATCH_400_3Dgrey_192';
...
opts.modelName        = ['MWCNN_GDSigma' num2str(opts.sigma) '_3_3Dgrey_400']; %%% model name
