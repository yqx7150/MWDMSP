...
net = add_conv(net, ['LIEVE' num2str(l1, '%02d') '_layer' num2str(ll1, '%02d')], {['LIEVE' num2str(l1, '%02d') '_t'], ['LIEVE' num2str(l1, '%02d') '_x' num2str(ll1, '%02d')]},...
    {['LIEVE' num2str(l1, '%02d') '_layer' num2str(ll1, '%02d') 'f'],  ['LIEVE' num2str(l1, '%02d') '_layer' num2str(ll1, '%02d') 'b']}, [h_default w_default 12 feature_map_size], 1);
...
net = add_conv(net, ['LIEVE' num2str(l1, '%02d') '_layer' num2str(ll1, '%02d')], {['LIEVE' num2str(l1, '%02d') '_r' num2str(ll1-1, '%02d')], 'prediction_res_multi'},...
    {['LIEVE' num2str(l1, '%02d') '_layer' num2str(ll1, '%02d') 'f'],  ['LIEVE' num2str(l1, '%02d') '_layer' num2str(ll1, '%02d') 'b']}, [h_default w_default feature_map_size 12], 1);
